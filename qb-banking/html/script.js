    ...
    methods: {
        ...
        openAccount() {
            ...
            axios
                ...
                .then((response) => {
                    if (response.data.success) {
                        const checkingAccount = this.accounts.find((acc) => acc.name === "个人");
                        ...
                        this.addStatement(this.accountNumber, "个人", "为" + this.createAccountName + "的初始存款", this.createAccountAmount, "withdraw");
                        this.addStatement(this.accountNumber, this.createAccountName, "初始存款", this.createAccountAmount, "deposit");
