...
Config.OxygenLevel = 240 -- this is oxygen level you can change this number as you like
...
Config.CoralLocations = {
    [1] = {
        ...
        coords = {
            ...
            Coral = {
                [1] = {
                    coords = vector3(-2849.25, -377.58, -42.23),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [2] = {
                    coords = vector3(-2838.43, -363.63, -41.45),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [3] = {
                    coords = vector3(-2811.11, -384.42, -40.83),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [4] = {
                    coords = vector3(-2847.86, -388.76, -41.34),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
    ...
    [2] = {
        ...
        coords = {
            ...
            Coral = {
                [1] = {
                    coords = vector3(-3274.13, -36.53, -23.05),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [2] = {
                    coords = vector3(-3284.03, -91.0, -35.18),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [3] = {
                    coords = vector3(-3256.11, -5.87, -16.58),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [4] = {
                    coords = vector3(-3285.5, 18.09, -17.79),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
                ...
                [5] = {
                    coords = vector3(-3276.0, -93.92, -35.7),
                    length = 3,
                    width = 3,
                    heading = 100.0,
                    PickedUp = false
