...
QBConfig.StatusInterval = 60000                          -- how often to check hunger/thirst status in milliseconds
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 50.0 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 50.0 -- Rate at which thirst goes down.
