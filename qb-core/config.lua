...
QBConfig.StatusInterval = 1                             -- how often to check hunger/thirst status in minutes

QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 500, bank = 5000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto' }                -- Money that is not allowed going in minus
QBConfig.Money.MinusLimit = 0                                    -- The maximum amount you can be negative 
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 5.0 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 6.0 -- Rate at which thirst goes down.
