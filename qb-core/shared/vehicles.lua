...
local Vehicles = {
    ...
    -- custom
    { model = 'su7',             name = 'SU7',                           brand = '小米',          price = 300000,  category = 'openwheel',      type = 'automobile', shop = 'luxury' },
    { model = 'rs721',           name = 'RS7',                           brand = '奥迪',            price = 2700000, category = 'openwheel',      type = 'automobile', shop = 'luxury' },
}
