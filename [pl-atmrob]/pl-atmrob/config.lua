...
-- rb_code
Config.successMusicDis = 200  
Config.successMusic = 'Don-Omar-_-Lucenzo-Danza-Kuduro'
Config.successMusicVol = 1.0

-- Item names for hacking and drilling
Config.HackingItem = 'cryptostick'  -- Default item name for hacking
Config.DrillItem = 'drill_green2'  -- Default item name for drilling
...
Config.MoneyModel = 'hei_prop_heist_cash_pile'
...
Config.CooldownTimer = 1200 -- default 10 minutes | 60 = 1 minute
...
Config.Reward = {
    ...
    hack_cash_pile = math.random(30, 40),  
    ...
    drill_cash_pile = math.random(15, 25),  
}
