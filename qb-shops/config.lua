...
Config.Products = {
    ...
    ['police'] = {
        ...
        { name = 'smg_ammo',            price = 20, amount = 50 },
        { name = 'shotgun_ammo',        price = 25, amount = 50 },
        { name = 'rifle_ammo',          price = 40, amount = 50 },
--         { name = 'handcuffs',           price = 0, amount = 50 },
        { name = 'empty_evidence_bag',  price = 10, amount = 50 },
        { name = 'police_stormram',     price = 300, amount = 50 },
        { name = 'armor',               price = 350, amount = 50 },
        { name = 'radio',               price = 1200, amount = 50 },
        { name = 'heavyarmor',          price = 700, amount = 50 },
    },
    ['ambulance'] = {
