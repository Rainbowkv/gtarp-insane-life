return {
    ...
    setup = {
        ...
        global = { enable = true, duration = 3000 }
    },
    ...
    registers = {
        ...
        minigame = {
            ...
            inputs = { '1', '2', '3', '4' },
            qbMinigameDifficulty = 'medium'  -- change to qb-minigame
        },
        ...
        reward = {
            { item = 'cash', min = 750, max = 1000, chance = 100 },
    ...
    computers = {
        ...
        minigame = {
            ...
            -- And in any amount/quantity - Learn more about the skillcheck
            -- Here: https://overextended.dev/ox_lib/Modules/Interface/Client/skillcheck
            difficulty = { 'easy', 'medium', 'easy', 'medium', 'medium','medium', },
            -- The 'inputs' are the keys that will be used for the skillcheck
            -- Minigame and can be set to any key or keys of your choice
            inputs = { '1', '2', '3', '4' },
            qbMinigameDifficulty = 'hard'  -- change to qb-minigame
        },
    },
    ...
    safes = {
        ...
        -- The 'item' can also be an account, such as 'cash' or 'bank'
        reward = {
            { item = 'cash', min = 1500, max = 2500, chance = 100 },
