    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>名: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>姓: </strong><span>" +
                ...
                "</span></p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"

            );
        } else if (itemData.name == "driver_license") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>名: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>姓: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>领证日期: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>驾照类型: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
                ...
                $.post(
                    ...
                    function(data) {
                        ...
                        $(".item-info-description").html(
                            ...
                            itemData.info.serie +
                            "</span></p><p><strong>弹量: </strong><span>" +
                            itemData.info.ammo +
                            "</span></p><p><strong>附件: </strong><span>" +
                            attachmentString +
                            "</span></p>"
                        );
                    })
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>证据类型: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>种类号: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>大小: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>序列号: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>犯罪场景: </strong><span>" +
                ...
                $(".item-info-description").html(
                    ...
                    "</span></p><p><strong>DNA编码: </strong><span>" +
                    itemData.info.dnalabel +
                    "</span></p><p><strong>犯罪场景: </strong><span>" +
                    itemData.info.street +
                    "</span></p><br /><p>" +
                    itemData.description +
                    "</p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
                );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.costs + "</p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "stickynote") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.label + "</p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>持有者: </strong><span>' + itemData.info.name + '</span></p><p><strong>公民ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>卡号: </strong><span>' + cardNumber + '</span></p><p style=\"font-size:11px\"><b>重量: </b>' + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "labkey") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Lab: " + itemData.info.lab + "</p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        }
    } else {
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>重量: </b>" + itemData.weight + " | <b>数量: </b> " + itemData.amount + " | <b>耐久: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
...
(() => {
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "使用 " + data.itemAmount + "x";
        if (data.type == "add") {
          type = "收到 " + data.itemAmount + "x";
        } else if (data.type == "remove") {
          type = "扣除 " + data.itemAmount + "x";
        }
