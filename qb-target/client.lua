...
local PlayerInteractions = Load('playerInteractions')  -- rb_code
local listSprite = {}
...
local function EnableNUI(options)
	...
	if Config.BackgroundBlur then  -- 背景模糊
...
-- rb_code
-- 前端事件，打开输入框让玩家输入金额
RegisterNetEvent('qb-target:client:openGiveCashInput', function(entity)
    -- 弹出框让玩家输入现金数额
